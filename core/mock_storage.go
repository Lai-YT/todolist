...
//
//	mockgen -source=storage.go -destination=mock_storage.go -package=core
//
...
func (m *MockStorageAccessor) Create(arg0 *TodoItem) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageAccessor) Read(where func(TodoItem) bool) []TodoItem {
	m.ctrl.T.Helper()
...
func (m *MockStorageAccessor) Update(todo TodoItem) error {
	m.ctrl.T.Helper()
